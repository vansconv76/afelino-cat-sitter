  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display font-semibold text-foreground">404</h1>
        <h2 className="mt-4 font-semibold text-foreground">Página não encontrada</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Afelino — Cat sitter em Alphaville e Tamboré" },
      {
        name: "description",
        content:
          "Cat sitting profissional em Alphaville e Tamboré: visitas domiciliares, medicação e relatórios com foto.",
      },
      { name: "author", content: "Afelino" },
